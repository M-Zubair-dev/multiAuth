...
<head>
    ...
    <!-- vendor css -->
    <link href="{{asset('public/admin_panel/lib/font-awesome/css/font-awesome.css')}}" rel="stylesheet">
    <link href="{{asset('public/admin_panel/lib/Ionicons/css/ionicons.css')}}" rel="stylesheet">
    <link href="{{asset('public/admin_panel/lib/perfect-scrollbar/css/perfect-scrollbar.css')}}" rel="stylesheet">
    <link href="{{asset('public/admin_panel/lib/rickshaw/rickshaw.min.css')}}" rel="stylesheet">

    <!-- Starlight CSS -->
    <link rel="stylesheet" href="{{asset('public/admin_panel/css/starlight.css')}}">
</head>
...
<body>
        ...
        <div class="sl-header-right">
            <nav class="nav">
                <div class="dropdown">
                   ...
                   document.getElementById('logout-form').submit();"><i class="icon ion-power"></i> {{ __('Logout') }}
                                </a></li>
    ...
    @endguest
    @yield('content')
    <script src="{{asset('public/admin_panel/lib/jquery/jquery.js')}}"></script>
    <script src="{{asset('public/admin_panel/lib/popper.js/popper.js')}}"></script>
    <script src="{{asset('public/admin_panel/lib/jquery-ui/jquery-ui.js')}}"></script>
    <script src="{{asset('public/admin_panel/lib/bootstrap/bootstrap.js')}}"></script>


    <script src="{{asset('public/admin_panel/lib/perfect-scrollbar/js/perfect-scrollbar.jquery.js')}}"></script>
    <script src="{{asset('public/admin_panel/lib/jquery.sparkline.bower/jquery.sparkline.min.js')}}"></script>
    <script src="{{asset('public/admin_panel/lib/d3/d3.js')}}"></script>
    <script src="{{asset('public/admin_panel/lib/rickshaw/rickshaw.min.js')}}"></script>
    <script src="{{asset('public/admin_panel/lib/chart.js/Chart.js')}}"></script>
    <script src="{{asset('public/admin_panel/lib/Flot/jquery.flot.js')}}"></script>
    <script src="{{asset('public/admin_panel/lib/Flot/jquery.flot.pie.js')}}"></script>
    <script src="{{asset('public/admin_panel/lib/Flot/jquery.flot.resize.js')}}"></script>
    <script src="{{asset('public/admin_panel/lib/flot-spline/jquery.flot.spline.js')}}"></script>

    <script src="{{asset('public/admin_panel/js/starlight.js')}}"></script>
    <script src="{{asset('public/admin_panel/js/ResizeSensor.js')}}"></script>
    <script src="{{asset('public/admin_panel/js/dashboard.js')}}"></script>
</body>
